...
/***/ "./node_modules/css-loader/index.js!./static/js/react/main.css":
/*!************************************************************!*\
  !*** ./node_modules/css-loader!./static/js/react/main.css ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./static/js/react/data/TimesheetData.ts":
/*!***********************************************!*\
  !*** ./static/js/react/data/TimesheetData.ts ***!
  \***********************************************/
/*! no static exports found */
...
var TimesheetDataCls = /** @class */ (function () {
    function TimesheetDataCls() {
    }
    TimesheetDataCls.prototype.parseRawFile = function (file) {
        var line, fileProcessed, desc, record, fileLinesArr;
        fileProcessed = [];
    ...
    return TimesheetDataCls;
}());
exports.TimesheetDataCls = TimesheetDataCls;
var TimesheetDataSingleton = new TimesheetDataCls();
exports.TimesheetData = TimesheetDataSingleton;


/***/ }),

/***/ "./static/js/react/data/index.ts":
/*!***************************************!*\
  !*** ./static/js/react/data/index.ts ***!
  \***************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var TimesheetData_1 = __webpack_require__(/*! ./TimesheetData */ "./static/js/react/data/TimesheetData.ts");
exports.TimesheetData = TimesheetData_1.TimesheetData;
...
__webpack_require__(/*! ./main.css */ "./static/js/react/main.css");

var _tools = __webpack_require__(/*! ./tools */ "./static/js/react/tools/index.js");

var _data = __webpack_require__(/*! ./data */ "./static/js/react/data/index.ts");
...
var TimesheetRecord = function (_React$Component) {
    _inherits(TimesheetRecord, _React$Component);

    function TimesheetRecord() {
        _classCallCheck(this, TimesheetRecord);

        return _possibleConstructorReturn(this, (TimesheetRecord.__proto__ || Object.getPrototypeOf(TimesheetRecord)).apply(this, arguments));
    }

    _createClass(TimesheetRecord, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'td',
                    { className: '' },
                    this.props.record.finish
                ),
                React.createElement(
                    'td',
                    { className: '' },
                    this.props.record.queue
                ),
                React.createElement(
                    'td',
                    { className: '' },
                    this.props.record.ticket
                ),
                React.createElement(
                    'td',
...
var TimesheetTable = function (_React$Component2) {
    _inherits(TimesheetTable, _React$Component2);

    function TimesheetTable(props) {
        _classCallCheck(this, TimesheetTable);

        return _possibleConstructorReturn(this, (TimesheetTable.__proto__ || Object.getPrototypeOf(TimesheetTable)).call(this, props));
        //        this.state = {
        //            data: []
        //        };
    }

    _createClass(TimesheetTable, [{
        key: 'renderData',
        value: function renderData(startIndex, endIndex) {
            var row = [];
            var i = startIndex || 0;
        ...
        value: function renderRecord(record) {
            return React.createElement(TimesheetRecord, { record: record, key: _tools.idGen.id('timesheet-record-') });
        }
    }, {
        key: 'render',
        value: function render() {
...
var TimesheetControls = function (_React$Component3) {
    _inherits(TimesheetControls, _React$Component3);

    function TimesheetControls(props) {
        _classCallCheck(this, TimesheetControls);

        var _this3 = _possibleConstructorReturn(this, (TimesheetControls.__proto__ || Object.getPrototypeOf(TimesheetControls)).call(this, props));
...
var TimesheetApp = function (_React$Component4) {
    ...
    function TimesheetApp(props) {
        _classCallCheck(this, TimesheetApp);

        var _this5 = _possibleConstructorReturn(this, (TimesheetApp.__proto__ || Object.getPrototypeOf(TimesheetApp)).call(this, props));
...
ReactDOM.render(React.createElement(TimesheetApp, null), document.getElementById('index'));

/***/ }),

/***/ "./static/js/react/main.css":
/*!**********************************!*\
  !*** ./static/js/react/main.css ***!
  \**********************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader!./main.css */ "./node_modules/css-loader/index.js!./static/js/react/main.css");
...
/***/ "./static/js/react/tools/idGen.js":
/*!****************************************!*\
  !*** ./static/js/react/tools/idGen.js ***!
  \****************************************/
/*! no static exports found */
...
var idGenCls = function () {
    function idGenCls() {
        _classCallCheck(this, idGenCls);

        this.counter = 0;
    }

    _createClass(idGenCls, [{
        key: 'id',
        value: function id(prefix) {
            var id = (prefix || '') + this.counter++;
            return id;
        }
    }]);
...
var idGenSingleton = new idGenCls();

exports.idGen = idGenSingleton;

/***/ }),

/***/ "./static/js/react/tools/index.js":
/*!****************************************!*\
  !*** ./static/js/react/tools/index.js ***!
  \****************************************/
/*! no static exports found */
...
var _idGen = __webpack_require__(/*! ./idGen */ "./static/js/react/tools/idGen.js");
